...
module.exports = {
    ...
    async execute(msg, args) {
        ...
        do {
            ...
            qMeme = query.data.data.children[Math.floor(Math.random() * query.data.data.children.length)].data;
        ...
        const embeds = embedUtility.message(meme.title, meme.subreddit, {
            ...
            iconURL: (await axios.get(`https://www.reddit.com/user/${meme.author}/about.json`)).data.data.icon_img.split("?")[0]
        });
        ...
        embeds[0].data.thumbnail = {url: "https://www.redditinc.com/assets/images/site/reddit-logo.png"};
